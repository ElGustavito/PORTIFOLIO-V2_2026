<?php
  ...
  $equipe = [
    ["nome" => "Eduardo Martino", "link" => "#", "foto" => "Imagens/Equipe/eduardo.png"],
    ["nome" => "Andre Nonaka",    "link" => "#", "foto" => "Imagens/Equipe/andre.png"],
    ["nome" => "Guilherme Hinori","link" => "#", "foto" => "Imagens/Equipe/guilherme.png"],
    ["nome" => "Gustavo Oliveira","link" => "#", "foto" => "Imagens/Fotos/Foto-Pessoal.png"],
    ["nome" => "Maria Julia",     "link" => "https://majupeloy.github.io/mjportfolio/", "foto" => "Imagens/Equipe/mariajulia.png"]
  ];
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
  ...
  <!-- HERO -->
  <header class="hero">
    <img src="Imagens/Projetos/Portal-Receitas.png" alt="Logo do Portal de Receitas" class="hero-logo">
    ...
    <div class="team-members">
      <?php foreach ($equipe as $membro): ?>
        <a href="<?php echo $membro['link']; ?>" class="member" target="_blank">
          <img src="<?php echo $membro['foto']; ?>" alt="<?php echo $membro['nome']; ?>" class="avatar">
  ...
  <script src="JavaScript/processo.js"></script>
